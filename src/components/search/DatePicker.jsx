...
function DatePicker({ label, value, onChange, placeholder, isOpen, onOpen, onClose }) {
    ...
    return (
        <div className="relative" ref={datePickerRef}>
            ...
            >
                <div className="icon-calendar absolute left-3 top-3 text-lg text-gray-500"></div>
          ...
          {selectedDate ? formatDate(selectedDate) : (placeholder || 'Select date')}
            ...
            {isOpen && (
                <div className="absolute z-50 mt-2 bg-white rounded-xl shadow-2xl border-2 border-purple-100 p-4 w-80 animate-slide-up">
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-2 text-sm rounded-lg transition-all ${
                                        isSelected
                                            ? 'bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold shadow-lg'
                                            : isToday
